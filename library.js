...
book_name = JSON.parse(localStorage.getItem("book_name"))
  ? JSON.parse(localStorage.getItem("book_name"))
  : [];
...
Display.prototype.deleteBook = function (target) {
  ...
  if (target.className === "delete") {
    ...
    book_name.splice(
      book_name.findIndex((book) => book.name === deletedname),
      1
    );
    console.log(book_name);
